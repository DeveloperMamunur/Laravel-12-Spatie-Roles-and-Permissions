<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Show user details') }}</flux:subheading>
    ...
    <div>
        ...
        <div class="overflow-x-auto w-150 p-3 mt-4">
            <p><span class="font-bold me-3">Name:</span>{{ $user->name }}</p>
            <p><span class="font-bold me-3">Email:</span>{{ $user->email }}</p>
        </div>
    </div>
</div>
